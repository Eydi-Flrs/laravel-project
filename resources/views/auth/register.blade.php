                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-1000 mb-4 ml-center" style="text-align:center">Create an Account!</h1>
                            </div>
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row ">
                                    <label for="email" class="">{{ __('TUP Email Address') }}</label>
                                ...
                                <div class="row ">
                                    <label for="contact_number" class="">{{ __('Contact number') }}</label>
